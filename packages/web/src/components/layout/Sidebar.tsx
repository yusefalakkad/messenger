...
export default function Sidebar() {
  ...
  return (
    <aside className="w-full h-full flex flex-col border-e border-white/10 lg:border-dark-border bg-dark-surface/40 lg:bg-dark-surface/80 backdrop-blur-xl relative pt-[var(--sat)]">
