...
export default function Sidebar() {
  ...
  return (
    <aside className="w-full lg:w-80 h-full flex flex-col border-r border-dark-border bg-dark-surface/40 lg:bg-dark-surface/80 backdrop-blur-xl relative pt-[var(--sat)]">
      ...
      <div className="flex gap-2 px-2 mb-1.5 flex-shrink-0">
        <motion.button
          ...
          whileTap={tap}
          transition={SPRING.snappy}
          className="flex-1 min-w-0 flex items-center gap-2.5 px-2.5 py-2 rounded-2xl text-left liquid-card group"
          title="Архивные чаты"
        >
